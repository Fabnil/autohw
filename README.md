...
theory retrieval - сбор релевантной теоретической информации / ссылок на прошлые задания / ссылок короче говоря на какие-то файлы + генерация промпта для планирования. Планирование и реализация будут идти в рамках одного диалога.
